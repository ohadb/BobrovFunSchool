...
describe("courseStore", () => {
  describe("getAllCourses", () => {
    ...
    it("returns all created courses", () => {
      createCourse({ name: "Math", description: "Math course", lessons: [] });
      createCourse({ name: "Science", description: "Science course", lessons: [] });
  ...
  describe("getCourseById", () => {
    it("returns course when found", () => {
      const created = createCourse({ name: "Math", description: "desc", lessons: [] });
  ...
  describe("updateCourse", () => {
    it("updates course name and description", () => {
      const created = createCourse({ name: "Math", description: "old", lessons: [] });
